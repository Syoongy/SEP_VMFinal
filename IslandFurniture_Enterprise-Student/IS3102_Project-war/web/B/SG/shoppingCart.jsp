        ...
        <script>
            ...
            function removeItem() {
                ...
                for (var i = 0, n = checkboxes.length; i < n; i++) {
                    if (checkboxes[i].checked) {
                        numOfTicks++;
                        removeList[removeList.length] = (checkboxes[i].value);
                    }
                }
                if (checkboxes.length == 0 || numOfTicks == 0) {
                    ...
                    window.event.returnValue = true;
                    document.shoppingCart.action = "../../ECommerce_RemoveItemFromListServlet?itemsToRemove=" + removeList;
                    document.shoppingCart.submit();
                }
            }
            ...
            function makePayment() {
                ...
                /*
                 ...
                 var securityNo = document.getElementById('txtSecuritycode');
                 var monthSelection = document.getElementById('month');
                 var selectedMonth = monthSelection.options[monthSelection.selectedIndex].text;
                                                ...
                                                <div class="col-md-8">
                                                    ...
                                                    <table>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td style="padding: 5px">
                                                                <input type="text" pattern="\d*" class="input-text text " title="cardno" id="txtCardNo" required>
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            <td style="padding: 5px">
                                                            ...
                                                            <td style="padding: 5px">
                                                                <input type="text" pattern="\d*" class="input-text text " title="securitycode" id="txtSecuritycode" required>
                                                            </td>
                                                        </tr>
            ...
            <div role="dialog" class="modal fade" id="makePaymentModal">
                <div class="modal-dialog">
                    <div class="modal-content">
                        ...
                        <div class="modal-footer">                        
                            <input class="btn btn-primary" name="btnPayment" type="submit" value="Confirm" onclick="if (document.getElementById('makePaymentForm').checkValidity())
                                        makePayment()"  />
                            <a class="btn btn-default" data-dismiss ="modal">Close</a>
                        </div>
                    </div>
