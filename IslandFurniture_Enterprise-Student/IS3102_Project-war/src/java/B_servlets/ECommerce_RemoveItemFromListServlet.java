...
public class ECommerce_RemoveItemFromListServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            String[] skuArray = request.getParameterValues("itemsToRemove");
            Iterator<ShoppingCartLineItem> cartIterator = shoppingCart.iterator();
            for (String sku : skuArray) {
                while(cartIterator.hasNext()) {
                    ShoppingCartLineItem item = cartIterator.next();
            ...
            String sucessResult = "Item removed successfully!";
